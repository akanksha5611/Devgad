        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formLogin" action="login.php" method="post">
                        <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form class="mt-3 collapse review-form-box" id="formRegister" action="./signup.php" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" name="InputPassword1" placeholder="Password"> </div>
                        </div>
